...
const Header = () => {
  ...
  return (
    <nav className="bg-[#FFFFFF] fixed w-full top-0 z-10 md:flex md:justify-between md:w-[100%] md:px-10 lg:px-[165px] ">
      <div className="flex items-center justify-between h-16 md:w-[100%]">
        <div className="flex items-center w-[100%] md:gap-10 lg:gap-[251px] md:items-center">
          <div className="flex-shrink-0">
            ...
            >
              ...
              <path
                ...
                fill="url(#paint0_linear_0_1048)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_0_1048"
                  x1="9.5"
                  y1="20"
                  x2="16.6529"
                  y2="3.01176"
          ...
          <div className="hidden md:flex md:justify-between md:w-full">
            <div className="ml-10 flex lg:justify-between md:m-0 md:items-center">
              {/* List items */}
              {menuItems.map((item, index) =>
                item.link !== location.pathname ? (
                  <a
                    key={index}
                    href={item.link}
                    className="text-[#000000] px-3 py-2 rounded-md text-[12px] font-dm-sans font-bold tracking-[2px]"
                  >
                    {item.name}
                  </a>
                ) : null
            ...
            <button className="w-[158px] py-3 bg-black text-white text-center font-dm-sans text-[12px] font-bold leading-normal tracking-widest ">
              GET AN INVITE
            </button>
          </div>
        </div>
