const BetaCard = () => {
  return (
    <div
      ...
      className="flex flex-col gap-6 px-[33px] pb-[64px] md:flex-row md:p-0 md:bg-[url(../../public/assets/shared/tablet/bg-beta.jpg)]"
    >
      <div
      ...
      ></div>
      <div className="">
        <h2 className="w-[95%]  text-[32px] text-[white] font-sans font-semibold leading-10 tracking-[3.333px] uppercase md:w-[50%]">
